...
const Settings = () => {
  ...
  document.title = "Profile Settings | android arsenal";
                            ...
                            <Card className="mt-n5">
                                <CardBody className="p-4">
                                    <div className="text-center">
                                        ...
                                        <h5 className="fs-16 mb-1">{authUser?.user_name}</h5>
                                ...
                                <CardBody>
                                    ...
                                    <div className="mb-3 d-flex">
                                        ...
                                        <Input type="text" className="form-control" id="websiteInput"
                                            placeholder="www.example.com" defaultValue="www.android-arsenalcom" />
                                    </div>
                                    <div className="mb-3 d-flex">
                                        <div className="avatar-xs d-block flex-shrink-0 me-3">
          ...
          <Card className="mt-xxl-n5">
            ...
            <CardBody className="p-4">
              <TabContent activeTab={activeTab}>
                <TabPane tabId="1">
                  <Row>
                    <Col lg={2} className="flex-center mb-4 mb-lg-0">
                                                    ...
                                                    <Col lg={12}>
                                                        <div className="mb-3">
                                                            ...
                                                            <select className="form-select mb-3">
                                                                <option label='Select your Skill'>Select your Skill </option>
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input
                                                                ...
                                                                defaultValue="www.android-arsenalcom"
                                                            />
                                                        </div>
                                                    </Col>
                                                    <Col lg={4}>
                    ...
                    <div className="d-flex flex-column flex-sm-row mb-4 mb-sm-0 mt-2">
                      <div className="flex-grow-1">
                        ...
                        <p className="text-muted">
                          ...
                          includes a text with a code sent to your smartphone,
                          or biometrics using your fingerprint, face, or retina.
                        </p>
                      </div>
                      <div className="flex-shrink-0 ms-sm-3">
                        <Link to="#" className="btn btn-sm btn-primary">
                    ...
                    <div className="d-flex flex-column flex-sm-row mb-4 mb-sm-0 mt-2">
                      <div className="flex-grow-1">
                        ...
                        <p className="text-muted mb-sm-0">
                          ...
                          you turn on two-factor authentication through your
                          android or Android Twitter app. You can also generate
                          a backup code on twitter.com.
                        </p>
                      </div>
                      <div className="flex-shrink-0 ms-sm-3">
                        <Link to="#" className="btn btn-sm btn-primary">
