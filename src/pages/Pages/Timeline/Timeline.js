...
//import Images
import avatar5 from "../../../assets/images/faq-img.png";
import avatar4 from "../../../assets/images/faq-img.png";
import avatar3 from "../../../assets/images/faq-img.png";
import avatar7 from "../../../assets/images/faq-img.png";

import small2 from "../../../assets/images/faq-img.png";
import small3 from "../../../assets/images/faq-img.png";
import small4 from "../../../assets/images/faq-img.png";
import small6 from "../../../assets/images/faq-img.png";
import small7 from "../../../assets/images/faq-img.png";
import small10 from "../../../assets/images/faq-img.png";
import small9 from "../../../assets/images/faq-img.png";

const Timeline = () => {
  SwiperCore.use([FreeMode, Navigation, Thumbs]);
  const [thumbsSwiper] = useState(null);

  document.title = "Timeline | android arsenal";
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted">
                        Every team project can have a android-arsenal Use the
                        android-Arsenal to share information with your team to
                  ...
                  <div className="timeline-item left">
                    ...
                    <div className="content">
                      <h5>
                        android-Arsenal admin dashboard templates layout upload
                      </h5>
                      <p className="text-muted">
                  ...
                  <div className="timeline-continue">
                    ...
                    <Row className="timeline-right">
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            <h5>android-Arsenal - Project Discussion</h5>
                            <p className="text-muted mb-0">
