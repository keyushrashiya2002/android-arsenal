...
import defaultDemo from "../../../assets/images/faq-img.png";
import saasDemo from "../../../assets/images/faq-img.png";
import materialDemo from "../../../assets/images/faq-img.png";
import minimalDemo from "../../../assets/images/faq-img.png";
import creativeDemo from "../../../assets/images/faq-img.png";
import modernDemo from "../../../assets/images/faq-img.png";
import interactiveDemo from "../../../assets/images/faq-img.png";
            ...
            <Col lg={8} sm={10}>
              <div className="text-center mt-lg-5 pt-5">
                <h1 className="display-6 fw-semibold mb-3 lh-base">
                  ...
                  <span className="text-success">android-Arsenal </span>
                </h1>
                <p className="lead text-muted lh-base">
                  android-Arsenal is a fully responsive, multipurpose and
                  premium Bootstrap 5 Admin & Dashboard Template built in
                  multiple frameworks.
                </p>
